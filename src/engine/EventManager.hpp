...
public:
    ...
    void processEvents(sfev::EventCallback fallback = nullptr) const
    {
        // Iterate over events
        sf::Event event;
    ...
    void processEvent(const sf::Event &event, sfev::EventCallback fallback = nullptr) const
    {
        m_event_map.executeCallback(event, fallback);
    }
